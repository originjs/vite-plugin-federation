...
import { B as parseQuery, n as hasProtocol, i as joinURL, o as isScriptProtocol, D as withTrailingSlash, E as withoutTrailingSlash } from '../_/nitro.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-41e8884e><div class="fixed left-0 right-0 spotlight z-10" data-v-41e8884e></div><div class="max-w-520px text-center z-20" data-v-41e8884e><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-41e8884e>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-41e8884e>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-41e8884e>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../../node_modules/.pnpm/nuxt@3.21.8_@parcel+watcher_4da9201b62ceb2f73457fc84721d89e9/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-41e8884e"]]);

export { error404 as default };
//# sourceMappingURL=error-404-D59WaRCJ.mjs.map
